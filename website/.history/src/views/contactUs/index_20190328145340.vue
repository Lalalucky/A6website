...
export default {
    ...
    methods: {
        ...
        addMapMarker(){
            let markerArr=[{title:'南京云宝网络有限公司',content:"地址：南京市雨花区大周路32号软件谷科创城A1栋15F<br/>邮编：210000<br/>客服：400-8292-877<br/>电话：025-52881988<br/>邮箱：yunbao@yunbaet.cn",pointer:"118.7502539064|31.9427714312",isOpen:1,icon:{w:23,h:25,l:46,t:21,x:9,lb:12}}]
            for(var i=0;i<markerArr.length;i++){
                var json = markerArr[i];
                console.log(json.point);
                var p0 = 118.7502539064;
                var p1 = 31.9427714312;
