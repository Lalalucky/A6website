...
export default {
    ...
    methods: {
        ...
        addMapMarker(){
            var markerArr=[{title:'南京云宝网络有限公司',content::"地址：南京市雨花区大周路32号软件谷科创城A1栋15F<br/>邮编：210000<br/>客服：400-8292-877<br/>电话：025-52881988<br/>邮箱：yunbao@yunbaet.cn",pointer:"118.7502539064, 31.9427714312",}]
        }
    }
};
</script>
