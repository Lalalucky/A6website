<template>
    ...
    <div>
        <Top :index="'0'"></Top>
        <div class="banner">
            <el-carousel :height="658+'px'" class="banner_item">
        ...
        <main>
            <WordCloud></WordCloud>
            <div class="yiEdu">
                <div class="column"><h1 class="theme"><span class="adorn"></span>易教育，能为您带来什么？</h1></div>
                <div class="sixAdv">
                    <ul class="tab">
            ...
            <YiHelper :h1="' &nbsp易教育如何帮您实现机构运营全面升级 '"></YiHelper>
            <YiServer></YiServer>
            <YiJob></YiJob>
            <div class="yiAchi">
