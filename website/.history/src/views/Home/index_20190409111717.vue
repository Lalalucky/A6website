        ...
        <div class="banner">
            <el-carousel :height="658+'px'" :interval=5000 class="banner_item">
                <el-carousel-item v-for="item in banner" :key="item">
                    <img :src="item" alt="">
                    <p class="guide">职业教培机构一站式信息化解决方案</p>
            ...
            <div class="yiEdu">
                ...
                <div class="sixAdv">
                    <ul class="tab">
                        ...
                        <router-link to="/home/sell" tag="li" :class="{active:this.currentView==marketing}">销售</router-link>
                        <router-link to="/home/bussiness" tag="li" :class="{active:this.currentView==marketing}">业务</router-link>
                        <router-link to="/home/source" tag="li" :class="{active:this.currentView==marketing}">资源</router-link>
                        <router-link to="/home/controls" tag="li" :class="{active:this.currentView==marketing}">管控</router-link>
                        <router-link to="/home/education" tag="li" :class="{active:this.currentView==marketing}">继续教育</router-link>
                    </ul>
