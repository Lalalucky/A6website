    ...
    <div>
        ...
        <main>
            ...
            <div class="yiEdu">
                ...
                <div class="sixAdv">
                    <ul class="tab">
                        <router-link to="/home/marketing" tag="li" :class="[active:this.currentView=='marketing',active]">营销</router-link>
                        ...
                        <router-link to="/home/source" tag="li" :class="{active:this.currentView=='source'}">资源</router-link>
