        ...
        <div class="detials">
            ...
            <div class="content">
                ...
                <div class="betweens_essay">
                    <div class="prev_essay" v-show="this.data.prev.id" @click="goToArticle(this.data.prev.id)">
                        上一篇文章：
                        <span>{{this.data.prev.headline}}</span>
                    </div>
                    <div class="next_essay" v-show="this.data.next.id" @click="goToArticle(this.data.next.id)">
                        下一篇文章：
                        <span>{{this.data.prev.headline}}</span>
                    </div>
                </div>
