    ...
    routes: [
        ...
        },
        {
            ...
            children: [
                {
                    path: '/academe/index/',
                    redirect: '/academe/index/company',
                    component: Company
                },
                {
                    path: '/academe/index/company',
                    component:Company
                },
                {
                    path: '/academe/index/industry',
                    component: Industry
                },
                {
                    path: '/academe/index/market',
                    component: Market
                },
                {
                    path: '/academe/index/organization',
                    component: Organization
                },
                {
                    path: '/academe/index/products',
                    component: Products
                },
                {
                    path: '/academe/index/experience',
