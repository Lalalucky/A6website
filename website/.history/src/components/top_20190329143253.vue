            ...
            >
                <div class="solutions" v-show="this.needShow==1" animate-delay="0s">
                    <div class="sixDisp">
                        ...
                        <div @click="solutions(1)">招生转化</div>
                        <div @click="solutions(1)">业务升级</div>
                        <div @click="solutions(1)">教务教研</div>
                        <div @click="solutions(1)">信息职教</div>
                        <div @click="solutions(1)">一站到底</div>
                    </div>
                </div>
            </transition>
        </div>
