                    ...
                    <el-row class="navs" type="flex">
                        <el-col :span="3">
                            <router-link tag="div" to="/" class="nav">
                                <div class="nav" @mouseover="getIndex(0)" :class="[this.index==0?'underline':'']">首页</div>
                            </router-link>
                        </el-col>
                        <el-col :span="3">
                            <router-link tag="div" to="/solutions/index">
                                <div class="nav" @mouseover="getIndex(1)" :class="[this.index==1?'underline':'']">解决方案</div>
                            </router-link>
                        </el-col>
                        <el-col :span="3">
                            <router-link tag="div" to="/productsIntro/index">
                                <div class="nav" @mouseover="getIndex(2)" :class="[this.index==2?'underline':'']">产品介绍</div>
                            </router-link>
                        </el-col>
                        <el-col :span="3">
                            <router-link tag="div" to="/academe/index">
                                <div class="nav" @mouseover="getIndex(2)" :class="[this.index==3?'underline':'']">易学苑</div>
                            </router-link>
                        </el-col>
                        <el-col :span="3">
