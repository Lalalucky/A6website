        ...
        <div class="container">
            <div class="buildPath">
                <transition-group enter-active-class="fadeInLeft" leave-active-class="" v-on:before-enter="beforeEnter" v-on:enter="enter">
                    ...
                    <div class="tache animated" :key="2" v-show="showTime" animate-delay="400ms" animate-duration="400ms">
                    ...
                    <div class="tache animated" :key="3" v-show="showTime" animate-delay="800ms" animate-duration="400ms">
                    ...
                    <div class="tache animated" :key="4" v-show="showTime" animate-delay="1200ms" animate-duration="400ms">
                    ...
                    <div class="tache animated" :key="5" v-show="showTime" animate-delay="1600ms" animate-duration="400ms">
                    ...
                    <div class="tache animated" :key="6" v-show="showTime" animate-delay="2000ms" animate-duration="400ms">
