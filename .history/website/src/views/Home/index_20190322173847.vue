    ...
    <div>
        ...
        <div class="yiAchi">
            ...
            <div class="rollData">
                <div class="grow">
                    <h3>数据</h3>
                    <p><span ref="growYear" :data-time="time" :data-value="value">0</span>年专注产品打造</p>
                </div>
                <div class="grow">
                    <h3>数据</h3>
                    <p><span ref="growTimes" :data-time="time" :data-value="value">0</span>次产品功能升级</p>
                </div>
                <div class="grow">
                    <h3>数据</h3>
                    <p><span ref="growOrgNum" :data-time="time" :data-value="value">0</span>家机构合作伙伴</p>
                </div>
                <div class="grow">
                    <h3>数据</h3>
                    <p><span ref="growStuNum" :data-time="time" :data-value="value">0</span>位学员使用</p>
                </div>
            </div>
            <div class="konwMore">
                <div>免费体验</div>
