            ...
            <div class="yiPartner">
                ...
                <div class="container">
                    <el-carousel :height="450+'px'" arrow="always" :interval="4000" indicator-position="none" class="with_person">
                        <el-carousel-item v-for="item in 4" :key="item">
                            <div class="every">
                                <div class="mankind">这是这人{{item}}</div>
                                <div class="wordDisc">
                 ...
                 <!-- <el-carousel :height="450+'px'" arrow="always" :interval="4000" :indicator-position="none" class="with_person"> -->
                    <el-carousel :height="450+'px'" arrow="always" :interval="4000" indicator-position="none" class="with_brand">
                        <el-carousel-item v-for="item in 3" :key="item">
                            <div class="img_group">
                                <div class="imgs" v-for="(img,index) in 5" :key="index" ></div>
                            </div>
                        </el-carousel-item>
                    </el-carousel>
                </div>
