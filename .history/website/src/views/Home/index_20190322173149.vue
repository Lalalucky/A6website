    ...
    <div>
        ...
        <div class="yiAchi">
            ...
            <div class="rollData">
                ...
                <div class="grow">
                    <h3>数据</h3>
                    <p><span ref="growTimes" :data-time="time" :data-value="value">0</span></p>
                </div>
                <div class="grow">
                    <h3>数据</h3>
                    <p><span ref="growOrgNum" :data-time="time" :data-value="value">0</span></p>
                </div>
                <div class="grow">
                    <h3>数据</h3>
                    <p><span ref="growStuNum" :data-time="time" :data-value="value">0</span></p>
                </div>
            </div>
        </div>
    </div>
