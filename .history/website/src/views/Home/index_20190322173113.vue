    ...
    <div>
        ...
        <div class="yiAchi">
            ...
            <div class="rollData">
                ...
                <div class="grow">
                    <h3>数据</h3>
                    <span ref="growTimes" :data-time="time" :data-value="value">0</span>
                </div>
                <div class="grow">
                    <h3>数据</h3>
                    <span ref="growOrgNum" :data-time="time" :data-value="value">0</span>
                </div>
                <div class="grow">
                    <h3>数据</h3>
                    <span ref="growStuNum" :data-time="time" :data-value="value">0</span>
                </div>
            </div>
        </div>
    </div>
