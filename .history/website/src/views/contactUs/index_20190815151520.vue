...
export default {
    ...
    methods: {
        ...
        createMap() {
            ...
            var point = new BMap.Point(118.7409961224,31.9435674312);//定义一个中心点坐标
            ...
            var markerArr = [
                {
                    title: "南京云宝网络有限公司",
                    content:
                        "地址：南京市雨花区大周路32号软件谷科创城A1栋15F<br/>邮编：210000<br/>客服：400-8790-758<br/>电话：025-52881988<br/>邮箱：yunbao@yunbaonet.cn",
                    point: "118.7409961224|31.9372406969",
                    isOpen: 0,
